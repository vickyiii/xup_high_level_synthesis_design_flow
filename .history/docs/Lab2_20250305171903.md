...
6. In the report tab, expand and click on the **yuv_filter_Pipeline_RGB2YUV_LOOP_X_RGB2YUV_LOOP_Y** entry to open the report.
   ...
   **Question 2**Answer the following question pertaining to rgb2yuv function.Estimated clock period:Worst case latency:Number of DSP48E used:Number of FFs used:Number of LUTs used:
