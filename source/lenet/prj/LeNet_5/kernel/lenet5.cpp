...
#pragma HLS interface axis port=threshold0
#pragma HLS interface axis port=conv1_weight
#pragma HLS interface axis port=threshold1
#pragma HLS interface axis port=matmul0_weight
#pragma HLS interface axis port=out
#pragma HLS array_partition variable=in cyclic factor=WIDTH
#pragma HLS array_partition variable=conv0_weight cyclic factor=KERNEL*KERNEL
#pragma HLS array_partition variable=conv1_weight cyclic factor=CHANNEL
#pragma HLS array_partition variable=matmul0_weight cyclic factor=CHANNEL
