...
# Create a project
open_project -reset convolution0

# Add design files
add_files convolution0.cpp
# Add test bench & files
add_files -tb convolution0_tb.cpp

# Set the top-level function
set_top convolution0

# ########################################################
# Create a solution
open_solution -reset convolution0 -flow_target vivado
